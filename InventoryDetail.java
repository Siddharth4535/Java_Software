 ...
 * @author HZT
 */
public class InventoryDetail extends javax.swing.JFrame {
    ...
    public InventoryDetail() {
        ...
        List<Inventory> data=criteria.list();
        DefaultTableModel tm=(DefaultTableModel)jTable1.getModel(); // DOWN CASTING
        for(Inventory inventory:data)
        {
            Object obj[]={inventory.getProd_id(),inventory.getName(),inventory.getDescription(),inventory.getExpDate(),inventory.getQtyOrder(),inventory.getQtyRecivied(),inventory.getCost(),inventory.getStock()};
            tm.addRow(obj);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INVENTORY DETAIL");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRODUCT ID", "NAME", "DESCRIPTION", "EXPIRY DATE", "QUANTITY ORD.", "QUANTITY RECV.", "COST", "STOCK"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 700, 320));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new AddDataInventory().setVisible(true);
        dispose();
...
//        {
//            Object obj[]={doctor.getDoc_id(),doctor.getName()};
//            tm.addRow(obj);
//            jComboBox1.addItem(""+doctor.getDoc_id());
//        }
