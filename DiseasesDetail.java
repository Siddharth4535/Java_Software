 ...
 * @author HZT
 */
public class DiseasesDetail extends javax.swing.JFrame {

    /**
     * Creates new form DoctorDetail
     */
    public DiseasesDetail() {
        initComponents();
        ...
        Criteria criteria=session.createCriteria(Diseases.class);
        List<Diseases> data=criteria.list();
        DefaultTableModel tm=(DefaultTableModel)jTable1.getModel(); // DOWN CASTING
        for(medicare.Diseases ref:data)
        {
            Object obj[]={ref.getDis_id(),ref.getDisType(),ref.getCost(),ref.getDoc_id(),ref.getName()};
            tm.addRow(obj);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DISEASES DETAIL");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DISEASE ID", "DISEASE TYPE", "COST", "DOCTOR ID", "DOCTOR NAME"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new AddDataDiseases().setVisible(true);
        dispose();
